...
class GalleryWindow(PageWindow):
    ...
    def update_label(self,temp1,temp2,time):
        ...
        self.temp_reading.setText(str(temp1)+" °C")

        
        self.temp2_reading.setText(str(temp2)+" °C")
        #self.temp2_reading.setColor(QPalette.WindowText, QtGui.QColor("red"))
    ...
    def scrollView(self,dir):
        ...
        for img in self.imagearray:
            ...
            temp_reading.setText(str(temp_value1)+" °C")
            ...
            if temp_value2>=36.1 and temp_value2<=37.2:
                ...
                pal.setColor(QPalette.WindowText, QColor("red"))
                temp2_reading.setPalette(pal)
            temp2_reading.setText(str(temp_value2)+" °C")
            ...
            gridLayout_gallery.addWidget(temp2_reading,3,1,1,3)
...
#         Toolbar
    ...
    def toolbarUI(self):
       ...
       # plotGraph = QAction(QIcon(os.path.join('icon', 'chart_line.jpg')), 'Plot', self)
        ...
        #plotGraph.triggered.connect(self.main_window.on_pushButtonPlot_clicked)
